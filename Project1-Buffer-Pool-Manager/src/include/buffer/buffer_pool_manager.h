...
class BufferPoolManager {
 ...
 protected:
  ...
  /** This latch protects page_table_ & free_list_ & replacer. */
  /** No need to protect pages_, because each page has its own read latch & write latch. */
  /** No need to protect other members, because there are write operation for these members. */
  std::mutex latch_;
};
}  // namespace bustub
